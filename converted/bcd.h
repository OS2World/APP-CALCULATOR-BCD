...
private:
        ...
        void nnz();
        void shl(int t);
	friend void addpp(bcd *,const bcd *,unsigned);
	friend void subpp(bcd *,const bcd*,unsigned);
	friend int iszero(const bcd *, int prec);
	friend void m10(bcd*,unsigned);
	friend void d10(bcd *,unsigned);
};
